...
var removeClasses = function(elements) {
  var classes = ['photographer', 'about', 'developer', 'cover--photographer', 'cover--about', 'cover--developer', 'about-photo', 'about-dev', 'p-hover-about', 'd-hover-about', 'active--photographer', 'active--about', 'active--developer', 'contact-photo', 'contact-about'];
...
var openPhotography = function() {
  ...
  sections[3].classList.add('contact-photo');
};
...
var openAbout = function() {
  ...
  sections[2].classList.add('developer');
  sections[3].classList.add('contact-about');
};
  ...
  function($scope, $window) {
    $scope.projects = [
      ...
      },
      {
        ...
        link:"https://www.motorris.com"
      },
      {
        title:"Mission Feed",
        image:"images/projects/mission-feed.jpg",
        link:"https://www.missionfeed.com"
      }
    ];

    $scope.bakuro = [
      {
        imageURL: '/images/bakuro-art/skyline-long-red.jpg'
      },
      {
        imageURL: '/images/bakuro-art/skyline-long.jpg'
      },
      {
        imageURL: '/images/bakuro-art/overhanging-tree.jpg'
      },
      {
        imageURL: '/images/bakuro-art/mexico.jpg'
      },
      {
        imageURL: '/images/bakuro-art/Astro-Orbitor-Light-Trails.jpg'
      }
    ];
